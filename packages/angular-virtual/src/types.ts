...
import type { VirtualKey, Virtualizer } from '@tanstack/virtual-core'
...
> & {
  ...
  getVirtualItems: Signal<
    ReturnType<
      Virtualizer<TScrollElement, TItemElement, TKey>['getVirtualItems']
    >
  >
  isScrolling: Signal<
    Virtualizer<TScrollElement, TItemElement, TKey>['isScrolling']
  >
  ...
  >
  scrollRect: Signal<
    Virtualizer<TScrollElement, TItemElement, TKey>['scrollRect']
  >
}
